...
public class CodeUtils {
    ...
    public static String getSalt() {
        return DeriveBytes.generateSalt(saltSize);
    }
    ...
    public static String getHash(String password, String salt) {
        DeriveBytes keyGenerator = null;
        try {
            keyGenerator = new DeriveBytes(password + salt, saltSize, iterations);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static boolean verify(String hashedPassword, String password, String salt) {
        ...
        DeriveBytes deriveBytes = null;
        try {
            deriveBytes = new DeriveBytes(password + salt, bSalt, iterations);
        } catch (Exception e) {
            e.printStackTrace();
        }
