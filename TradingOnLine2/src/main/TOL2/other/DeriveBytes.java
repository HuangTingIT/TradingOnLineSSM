...
public class DeriveBytes {
     ...
     */
    public DeriveBytes(byte[] password, byte[] salt, int iterations) throws NoSuchAlgorithmException,
            InvalidKeyException {
        this.salt = salt;
     ...
     */
    public DeriveBytes(String password, int saltSize, int iterations) throws NoSuchAlgorithmException,
     ...
     * @throws UnsupportedEncodingException
     */
    public DeriveBytes(String password, int saltSize) throws NoSuchAlgorithmException, InvalidKeyException,
     ...
     */
    public DeriveBytes(String password, byte[] salt, int iterations) throws InvalidKeyException,
